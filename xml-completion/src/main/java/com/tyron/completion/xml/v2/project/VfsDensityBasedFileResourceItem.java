...
public final class VfsDensityBasedFileResourceItem extends VfsFileResourceItem
   ...
   */
  public VfsDensityBasedFileResourceItem(
   ...
   * @param relativePath defines location of the resource. Exact semantics of the path may vary
   *     depending on the resource repository
   * @param virtualFile the virtual file associated with the resource, or null of the resource is
   *     out of date
   * @param density the screen density this resource is associated with
   */
  public VfsDensityBasedFileResourceItem(
