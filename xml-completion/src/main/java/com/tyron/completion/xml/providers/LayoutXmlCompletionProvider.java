...
public class LayoutXmlCompletionProvider extends CompletionProvider {
  ...
  public CompletionList complete(CompletionParameters params) {
    ...
    try {
      ...
      XmlCompletionType completionType = XmlUtils.getCompletionType(parsed, params.getIndex());
      ...
      mCachedCompletion =
          new CachedCompletion(
              params.getFile(), params.getLine(), params.getColumn(), builder.getPrefix(), build);
      return build;
  ...
  protected CompletionList.Builder completeInternal(
      Project project,
