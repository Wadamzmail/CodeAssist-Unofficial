...
public class AppResourceRepository extends MultiResourceRepository {
  ...
  @NotNull
  static AppResourceRepository create(
      @NotNull AndroidModule facet,
      @NotNull Collection<AarResourceRepository> libraryRepositories) {
  ...
  @Nullable private Collection<File> myResourceDirs;
  ...
  private AppResourceRepository(
      @NotNull AndroidModule androidModule,
