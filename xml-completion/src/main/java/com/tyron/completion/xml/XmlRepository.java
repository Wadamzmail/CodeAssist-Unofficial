...
public class XmlRepository {
  ...
  private Map<String, DeclareStyleable> parse(Reader reader, String namespace)
  ...
  private Map<String, DeclareStyleable> parse(File file, String namespace)
      throws XmlPullParserException, IOException {
  ...
  private DeclareStyleable parseDeclareStyleable(XmlPullParser parser, String namespace)
  ...
  private AttributeInfo parseAttributeInfo(XmlPullParser parser)
      throws IOException, XmlPullParserException {
    String name = getAttributeValue(parser, "name", "");
  ...
  public static XmlRepository getRepository(Project project, AndroidModule module)
      throws IOException {
