...
public class BasicTextValueResourceItem extends BasicValueResourceItem
    implements TextResourceValue {
   ...
   * @param rawXmlValue the raw xml value associated with the resource (see {@link
   *     ResourceValue#getRawXmlValue()})
   */
  public BasicTextValueResourceItem(
