...
/**
 * Resource item representing an attr resource that is defined in a namespace different from the
 * namespace of the owning AAR.
 */
public class BasicForeignAttrResourceItem extends BasicAttrResourceItem {
   ...
   */
  public BasicForeignAttrResourceItem(
