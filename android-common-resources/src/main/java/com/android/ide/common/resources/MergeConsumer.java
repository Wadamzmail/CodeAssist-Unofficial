...
public interface MergeConsumer<I extends DataItem> {
      ...
      super(
          ...
          new Message(
              ...
              MoreObjects.firstNonNull(
                  cause.getLocalizedMessage(), cause.getClass().getCanonicalName()),
  ...
  /**
   * Removes an item. Optionally pass the item that will replace this one. This methods does not do
   * the replacement. The replaced item is just there in case the removal can be optimized when it's
   * a replacement vs. a removal.
   *
