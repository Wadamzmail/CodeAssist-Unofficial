 ...
 * drawable XML). It is always a mirror of a normal {@link ResourceSet} which delegates to this set
 * when it encounters a file that needs to be replaced by generated files.
 */
public class GeneratedResourceSet extends ResourceSet {
  ...
  public GeneratedResourceSet(
      String name, ResourceNamespace namespace, String libraryName, @Nullable String aaptEnv) {
