...
public class AndroidManifestParser {
  ...
  public interface ManifestErrorHandler extends ErrorHandler {
     ...
     *
     * <p>Errors are put as {@code org.eclipse.core.resources.IMarker} on the manifest file.
     *
     ...
     */
    void checkClass(
        Locator locator, String className, String superClassName, boolean testVisibility);
  }

  /**
   * XML error and data handler used when parsing the AndroidManifest.xml file.
   *
   * <p>During parsing this will fill up the {@link ManifestData} object given to the constructor
  ...
  private static class ManifestHandler extends DefaultHandler {
          ...
          switch (mValidLevel) {
            case LEVEL_TOP:
              if (AndroidManifest.NODE_MANIFEST.equals(localName)) {
                ...
                mManifestData.mPackage =
                    getAttributeValue(
                        attributes, AndroidManifest.ATTRIBUTE_PACKAGE, false /* hasNamespace */);

                // and the versionCode
                String tmp =
                    getAttributeValue(attributes, AndroidManifest.ATTRIBUTE_VERSIONCODE, true);
                if (tmp != null) {
                  try {
                ...
                mManifestData.mVersionName =
                    getAttributeValue(
                        attributes, AndroidManifest.ATTRIBUTE_VERSIONNAME, true /* hasNamespace */);
                mValidLevel++;
              }
              break;
            case LEVEL_INSIDE_MANIFEST:
              if (AndroidManifest.NODE_APPLICATION.equals(localName)) {
                ...
                value =
                    getAttributeValue(
                        attributes, AndroidManifest.ATTRIBUTE_REQUIRED, true /*hasNamespace*/);
                if (value != null) {
                ...
                value =
                    getAttributeValue(
                        attributes, AndroidManifest.ATTRIBUTE_GLESVERSION, true /*hasNamespace*/);
                if (value != null) {
                  try {
            ...
            case LEVEL_INSIDE_APPLICATION:
              if (AndroidManifest.NODE_ACTIVITY.equals(localName)
                ...
                processNode(attributes, SdkConstants.CLASS_BROADCASTRECEIVER, localName);
                mValidLevel++;
              } else if (AndroidManifest.NODE_PROVIDER.equals(localName)) {
                processNode(attributes, SdkConstants.CLASS_CONTENTPROVIDER, localName);
                mValidLevel++;
    ...
    private void processApplicationNode(Attributes attributes) {
      String value =
          getAttributeValue(attributes, AndroidManifest.ATTRIBUTE_PROCESS, true /* hasNamespace */);
      if (value != null) {
      ...
      value =
          getAttributeValue(
              attributes, AndroidManifest.ATTRIBUTE_DEBUGGABLE, true /* hasNamespace*/);
      if (value != null) {
      ...
      value =
          getAttributeValue(
              attributes, AndroidManifest.ATTRIBUTE_BACKUP_AGENT, true /* hasNamespace*/);
    ...
    private void processActivityNode(Attributes attributes) {
      ...
      String activityName =
          getAttributeValue(attributes, AndroidManifest.ATTRIBUTE_NAME, true /* hasNamespace */);
      if (activityName != null) {
        activityName = combinePackageAndClassName(mManifestData.mPackage, activityName);

        // get the exported flag.
        String exportedStr =
            getAttributeValue(attributes, AndroidManifest.ATTRIBUTE_EXPORTED, true);
        boolean exported =
            exportedStr == null || exportedStr.toLowerCase(Locale.US).equals("true"); // $NON-NLS-1$
        ...
        if (mErrorHandler != null) {
          mErrorHandler.checkClass(
              mLocator, activityName, SdkConstants.CLASS_ACTIVITY, true /* testVisibility */);
        }
      } else {
      ...
      if (activityName != null) {
        mManifestData.mKeepClasses.add(
            new ManifestData.KeepClass(activityName, processName, AndroidManifest.NODE_ACTIVITY));
      }
    }
    ...
    private void processNode(Attributes attributes, String superClassName, String localName) {
      ...
      if (serviceName != null) {
        ...
        if (mErrorHandler != null) {
          mErrorHandler.checkClass(
              mLocator, serviceName, superClassName, false /* testVisibility */);
        }
      }
    ...
    private void processInstrumentationNode(Attributes attributes) {
      ...
      if (instrumentationName != null) {
        ...
        String targetPackage =
            getAttributeValue(
                attributes, AndroidManifest.ATTRIBUTE_TARGET_PACKAGE, true /* hasNamespace */);
        mManifestData.mInstrumentations.add(new Instrumentation(instrClassName, targetPackage));
        mManifestData.mKeepClasses.add(
            new ManifestData.KeepClass(instrClassName, null, AndroidManifest.NODE_INSTRUMENTATION));
        if (mErrorHandler != null) {
          mErrorHandler.checkClass(
              mLocator,
              instrClassName,
    ...
    private void processSupportsScreensNode(Attributes attributes) {
      ...
      mManifestData.mSupportsScreensFromManifest.setResizeable(
          getAttributeBooleanValue(
              attributes, AndroidManifest.ATTRIBUTE_RESIZEABLE, true /*hasNamespace*/));

      mManifestData.mSupportsScreensFromManifest.setAnyDensity(
          getAttributeBooleanValue(
              attributes, AndroidManifest.ATTRIBUTE_ANYDENSITY, true /*hasNamespace*/));

      mManifestData.mSupportsScreensFromManifest.setSmallScreens(
          getAttributeBooleanValue(
              attributes, AndroidManifest.ATTRIBUTE_SMALLSCREENS, true /*hasNamespace*/));

      mManifestData.mSupportsScreensFromManifest.setNormalScreens(
          getAttributeBooleanValue(
              attributes, AndroidManifest.ATTRIBUTE_NORMALSCREENS, true /*hasNamespace*/));

      mManifestData.mSupportsScreensFromManifest.setLargeScreens(
          getAttributeBooleanValue(
    ...
    private void processUsesConfiguration(Attributes attributes) {
      ...
      mManifestData.mUsesConfiguration.mReqFiveWayNav =
          getAttributeBooleanValue(
              attributes, AndroidManifest.ATTRIBUTE_REQ_5WAYNAV, true /*hasNamespace*/);
      mManifestData.mUsesConfiguration.mReqNavigation =
          Navigation.getEnum(
              getAttributeValue(
                  attributes, AndroidManifest.ATTRIBUTE_REQ_NAVIGATION, true /*hasNamespace*/));
      mManifestData.mUsesConfiguration.mReqHardKeyboard =
          getAttributeBooleanValue(
              attributes, AndroidManifest.ATTRIBUTE_REQ_HARDKEYBOARD, true /*hasNamespace*/);
      mManifestData.mUsesConfiguration.mReqKeyboardType =
          Keyboard.getEnum(
              getAttributeValue(
                  attributes, AndroidManifest.ATTRIBUTE_REQ_KEYBOARDTYPE, true /*hasNamespace*/));
      mManifestData.mUsesConfiguration.mReqTouchScreen =
          TouchScreen.getEnum(
              getAttributeValue(
                  attributes, AndroidManifest.ATTRIBUTE_REQ_TOUCHSCREEN, true /*hasNamespace*/));
    }
    ...
    /**
     * Searches through the attributes list for a particular one and returns its value as a Boolean.
     * If the attribute is not present, this will return null.
     *
     * @param attributes the attribute list to search through
     * @param attributeName the name of the attribute to look for.
     * @param hasNamespace indicates whether the attribute has an android namespace.
    ...
    /**
     * Combines a java package, with a class value from the manifest to make a fully qualified class
     * name
     *
  ...
  static {
    sParserFactory =
        SAXParserFactory.newInstance(
            "org.openjdk.com.sun.org.apache.xerces.internal.jaxp.SAXParserFactoryImpl", null);
    XmlUtils.configureSaxFactory(sParserFactory, true, false);
  }

  /**
   * Parses the Android Manifest, and returns a {@link ManifestData} object containing the result of
   * the parsing.
   *
