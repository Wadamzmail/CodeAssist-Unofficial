...
/**
 * Used to store debouncers and retrieve them according to their call-site. Useful when debouncing
 * many different methods, and you don't want to store each DebounceExecutor in its own field.
 *
 * @param <K> the type of key that uniquely identifies debounced methods.
 */
public class DebouncerStore<K> {
  ...
  /** Creates a debouncer for this key if none alreay exists, or return the existing one. */
