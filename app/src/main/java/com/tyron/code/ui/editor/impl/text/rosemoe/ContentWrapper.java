...
public class ContentWrapper extends Content implements com.tyron.editor.Content {
  ...
  public void insert(int line, int column, CharSequence text) {
    ...
    updateText(
        newText, offset, "", newString, false, System.currentTimeMillis(), offset, 0, offset);
  }
  ...
  protected void changedUpdate(
      @NonNull ContentEvent event, long newModificationStamp, @NonNull CharSequence prevText) {
