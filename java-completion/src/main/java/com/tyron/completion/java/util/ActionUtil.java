...
public class ActionUtil {
  ...
  public static boolean containsVariableAtScope(
      String name, long position, JavacUtilitiesProvider parse) {
  ...
  public static boolean containsVariableAtScope(
      String name, JavacUtilitiesProvider parse, TreePath path) {
