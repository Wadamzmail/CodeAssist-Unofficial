...
public abstract class JavacTreeElementPattern<
        ...
        Self extends JavacTreeElementPattern<ParentType, T, Self>>
    ...
    public Self withSuperParent(final int level, @NotNull final ElementPattern<? extends ParentType> pattern) {
        return with(new PatternConditionPlus<T, ParentType>(
    ...
    public final Self insideSequence(
            ...
            final ElementPattern<? extends ParentType>... patterns) {
    ...
    public Self afterSiblingSkipping(
            @NotNull final ElementPattern skip,
            final ElementPattern<? extends ParentType> pattern) {
