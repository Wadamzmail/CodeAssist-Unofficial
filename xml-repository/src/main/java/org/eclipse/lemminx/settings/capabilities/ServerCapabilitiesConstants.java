...
public class ServerCapabilitiesConstants {
  ...
  public static final CompletionOptions DEFAULT_COMPLETION_OPTIONS =
  ...
  public static final CodeActionOptions DEFAULT_CODEACTION_OPTIONS =
      createDefaultCodeActionOptions();
