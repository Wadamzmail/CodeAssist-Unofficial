 ...
 *
 * <p>Contributors: Red Hat <nkomonen@redhat.com> - initial API and implementation
 */
...
public class AllXMLSettings {
  ...
  public static Object getAllXMLSettings(Object initializationOptionsSettings) {
    AllXMLSettings settings =
        JSONUtility.toModel(initializationOptionsSettings, AllXMLSettings.class);
