...
public class XMLSymbolSettings {
  ...
  /**
   * Will use the excluded pattern strings to create a list of {@link XMLExcludedSymbolFile} objects
   * within this object.
   *
   * @param excluded
   */
   ...
   *
   * <p>A uri is 'excluded' if it matches any of the given patterns.
   *
   * <p>**Important:** Set the excluded file patterns before calling this using 'setExcluded()'.
   *
   * @param uri
   * @return
   */
