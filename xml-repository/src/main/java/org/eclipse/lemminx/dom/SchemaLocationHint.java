/**
 * Copyright (c) 2020 Red Hat Inc. All rights reserved. This program and the accompanying materials
...
public class SchemaLocationHint implements DOMRange {
  ...
  /**
   * Create a new SchemaLocationHint object that represents one of the location hints given in the
   * parent <code>SchemaLocation</code>.
   *
