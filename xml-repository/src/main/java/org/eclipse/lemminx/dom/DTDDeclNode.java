...
public class DTDDeclNode extends DOMNode {
   ...
   *
   * <p>It can also be used to represent an undefined tag, meaning it is not any of: ELEMENT,
   * ATTLIST, ENTITY, or NOTATION
   */
  public DTDDeclParameter
      unrecognized; // holds all content after parsing goes wrong in a DTD declaration (ENTITY,

  // ATTLIST, ...).
  public DTDDeclParameter
      declType; // represents the actual name of the decl eg: ENTITY, ATTLIST, ...
  ...
  /**
   * Returns the parameter name which references a DTD element declaration (<!ELEMENT) at the given
   * offset and null otherwise.
   *
   * <p><!ATTLIST element-name ... will return position of 'element-name' which references the
   * <!ELEMENT element-name
   *
   * @param offset the offset
   * @return the parameter name which references a DTD element declaration (<!ELEMENT) at the given
   *     offset and null otherwise.
   */
