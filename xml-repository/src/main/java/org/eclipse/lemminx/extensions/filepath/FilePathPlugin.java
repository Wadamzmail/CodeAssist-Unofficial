...
public class FilePathPlugin implements IXMLExtension {
  ...
  private void updateSettings(ISaveContext saveContext) {
    ...
    FilePathSupportSettings settings =
        FilePathSupportSettings.getFilePathsSettings(initializationOptionsSettings);
  ...
  /**
   * Return the list of {@link FilePathExpression} for the given document and an empty list
   * otherwise.
   *
  ...
  private void fillFromParticipants(
      DOMDocument xmlDocument, List<IFilePathExpression> allExpressions) {
  ...
  private void fillFromUserSettings(
      DOMDocument xmlDocument, List<IFilePathExpression> expressions) {
  ...
  private static void fillFromMappings(
      DOMDocument xmlDocument,
      List<FilePathMapping> mappings,
  ...
  private synchronized void loadFilePathSupportParticipants() {
    ...
    Iterator<IFilePathSupportParticipant> extensions =
        ServiceLoader.load(IFilePathSupportParticipant.class).iterator();
