...
public abstract class CatalogEntry {
  ...
  /**
   * @param baseURI <catalog>'s xml:base + <group>'s xml:base (if in a <group>)
  ...
  /**
   * Returns the range in the document where the link to an external document is, or null if this
   * catalog entry does not refer to an external document
   *
  ...
  /**
   * Returns the URI for the document that this catalog entry references, or null if this catalog
   * entry does not refer to an external document
   *
