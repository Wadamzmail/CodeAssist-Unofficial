 ...
 *
 * <p>Given this XML: <root> &mdash -> Error: The reference to entity "mdash" must end with the ';'
 * delimiter </root>
 *
 * <p>To fix the error, the code action will suggest adding ';' <root> &mdash; </root>
 */
