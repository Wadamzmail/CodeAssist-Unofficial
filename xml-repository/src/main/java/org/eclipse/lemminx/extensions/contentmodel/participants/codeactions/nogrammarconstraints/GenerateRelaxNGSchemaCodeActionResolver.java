 ...
 *
 * <ul>
 *   <li>generate the RelaxNG file for the given DOM document
 *   <li>generate the association relaxng in the XML to bind it with the generated RelaxNG schema
 * </ul>
 */
public class GenerateRelaxNGSchemaCodeActionResolver
    extends AbstractGenerateGrammarAndAssociationResolveCodeActionParticipant {

  public static final String PARTICIPANT_ID =
      GenerateRelaxNGSchemaCodeActionResolver.class.getName();
