 ...
 *
 * <p>The {@link XMLValidationRootSettings}{@link #filters} can be used to define custom validation
 * rule for a given file pattern: <code>
 * [
 * {
 * "pattern": "**.exsd",
 * "enabled": false
...
public class XMLValidationRootSettings extends XMLValidationSettings {
  ...
  /**
   * Returns validation filters to define custom validation rule for a given file pattern and null
   * otherwise.
   *
   * @return validation filters to define custom validation rule for a given file pattern and null
   *     otherwise.
   */
   ...
   * @returnthe validation settings for the given uri and the global validation settings otherwise.
   */
