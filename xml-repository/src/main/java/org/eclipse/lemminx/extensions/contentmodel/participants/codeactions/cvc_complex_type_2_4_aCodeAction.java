...
public class cvc_complex_type_2_4_aCodeAction implements ICodeActionParticipant {
   ...
   * @throws Exception
   */
  private static Collection<CMElementDeclaration> getPossibleElements(
      DOMElement element, IComponentProvider componentProvider) throws Exception {
    ContentModelManager contentModelManager =
        componentProvider.getComponent(ContentModelManager.class);
