...
/**
 * XML Command "xml.check.file.pattern" whose first argument is a file pattern, and whose second
 * argument is some file URI. The command returns true when the given pattern matches against the
 * given file URI and false otherwise.
 */
