/**
 * Copyright (c) 2023 Omar Farag. All rights reserved. This program and the accompanying materials
 ...
 *
 * <p>Contributors: Omar Farag <omarfarag74@gmail.com> - initial API and implementation
 */
...
public class src_annotationCodeAction implements ICodeActionParticipant {
  ...
  private static List<String> potentialTags =
  ...
  public void doCodeAction(
    ...
    for (String potentialTag : potentialTags) {
      ...
      CodeAction replaceAction =
          CodeActionFactory.replace(
              codeActionText + "'" + potentialTag + "'",
              edits,
