...
public class required_elements_missing_expectedCodeActionResolver
  ...
  public static final String PARTICIPANT_ID =
      required_elements_missing_expectedCodeActionResolver.class.getName();
        ...
        if (matchesCMElement != null) {
          ...
          for (CMElementDeclaration child :
            ...
            if (child.getLocalName().equals(request.getDataProperty(DATA_ELEMENT_FIELD))) {
              ...
              resolved.setEdit(
                  CodeActionFactory.getReplaceWorkspaceEdit(
                      replaceText, targetRange, document.getTextDocument()));
            }
          }
        }
      }
