...
public class PrologModel {
  ...
  public static final List<String> ENCODING_VALUES =
      Arrays.asList(UTF_8, ISO_8859_1, WINDOWS_1251, WINDOWS_1252, SHIFT_JIS, GB2312, EUC_KR);
  ...
  public static void computeAttributeNameCompletionResponses(
    ...
    if (attrIndex == 2) { // 3rd attribute
      ...
      if (!STANDALONE_NAME.equals(attrBefore.getName())
          && !isCurrentAttributeEqual(STANDALONE_NAME, prolog, 2)) {
        createCompletionItem(
            STANDALONE_NAME,
            isSnippetsSupported,
            true,
   ...
   * <p>example:
   *
   * <p><element a="1" b="2" | c="3">
   *
   * <p>This will return 2 since if you insert a new attribute there you can access it from the list
   * of attributes with this index.
   *
