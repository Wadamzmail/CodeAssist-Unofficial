 ...
 * XSD documentation
 *
 * <p>Represents documentation coming from an XML schema file
 */
public class XSDDocumentation {
  ...
  public XSDDocumentation(
      XSObjectList annotations, SchemaDocumentationType docStrategy, boolean convertToPlainText) {
  ...
  /**
   * Returns formatted documentation that displays contents of the documentation element (if exists)
   * and the appinfo element (if exists).
   *
   * <p>The returned documentation will return raw html if <code>html</code> is true. Otherwise, the
   * returned documentation will be plaintext.
   *
   * @param html if true, the return value will contain raw html
   * @return formatted documentation that displays contents of the documentation element (if exists)
   *     and the appinfo element (if exists)
   */
  ...
  /**
   * Returns true if documentation title (ie, xs:documentation, xs:appinfo) should be preprended to
   * the documentation
   *
   * @return true if documentation title (ie, xs:documentation, xs:appinfo) should be preprended to
   *     the documentation
   */
  private boolean prependTitleCheck() {
    return this.documentation.size() > 0
        && this.appinfo.size() > 0
