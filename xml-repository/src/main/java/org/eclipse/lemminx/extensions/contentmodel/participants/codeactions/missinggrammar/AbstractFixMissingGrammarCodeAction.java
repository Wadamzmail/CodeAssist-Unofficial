...
public abstract class AbstractFixMissingGrammarCodeAction implements ICodeActionParticipant {
  ...
  public AbstractFixMissingGrammarCodeAction() {
    ...
    resolveCodeActionParticipants.put(
        GenerateDTDCodeActionResolver.PARTICIPANT_ID, new GenerateDTDCodeActionResolver());
    resolveCodeActionParticipants.put(
        GenerateXSDCodeActionResolver.PARTICIPANT_ID, new GenerateXSDCodeActionResolver());
  }
  ...
  public void doCodeAction(
    ...
    CodeAction makeSchemaFile =
        createGenerateFileCodeAction(request, diagnostic, missingFilePath, p, cancelChecker);
  ...
  private CodeAction createGenerateFileCodeAction(
    ...
    CodeAction makeSchemaFile =
        CodeActionFactory.createFile(
            title, "file:///" + missingFilePath, schemaTemplate, diagnostic);
    return makeSchemaFile;
  }
  ...
  /**
   * Extract the file to create from the diagnostic. Example diagnostic: schema_reference.4: Failed
   * to read schema document 'file:///home/dthompson/Documents/TestFiles/potationCoordination.xsd',
