...
public class XMLValidationSettings {
  ...
  /**
   * This severity preference to mark the root element of XML document which is not bound to a XML
   * Schema/DTD.
   *
   * <p>Values are {ignore, hint, info, warning, error}
   */
  ...
  /**
   * Returns true if a fatal error is thrown if the incoming document contains a DOCTYPE declaration
   * and false otherwise.
   *
   * @return true if a fatal error is thrown if the incoming document contains a DOCTYPE declaration
   *     and false otherwise.
   */
  ...
  /**
   * Set true if a fatal error is thrown if the incoming document contains a DOCTYPE declaration and
   * false otherwise.
   *
  ...
  /**
   * Returns the <code>noGrammar</code> severity according the given settings and {@link
   * DiagnosticSeverity#Hint} otherwise.
   *
   * @param validationSettings the validation settings
   * @return the <code>noGrammar</code> severity according the given settings and {@link
   *     DiagnosticSeverity#Hint} otherwise.
   */
  ...
  public boolean isRelatedInformation() {
    return publishDiagnostics != null
        && publishDiagnostics.getRelatedInformation() != null
