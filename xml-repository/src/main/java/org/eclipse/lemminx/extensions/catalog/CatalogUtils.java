...
public class CatalogUtils {
  ...
  private static final Collection<String> HAS_URI_ATTRIBUTE =
      Arrays.asList("public", "system", "uri", "systemSuffix", "uriSuffix");

  /** The catalog entries that have a 'catalog' attribute */
  private static final Collection<String> HAS_CATALOG_ATTRIBUTE =
      Arrays.asList("delegatePublic", "delegateSystem", "delegateUri", "nextCatalog");
  ...
  /**
   * Returns a list of all the catalog entries in the given document, or an empty list if the
   * document is not a catalog.
   *
   * @return a list of all the catalog entries in the given document, or an empty list if the
   *     document is not a catalog.
   */
   ...
   * @return the uri attribute node of the given catalog entry or null if there is no uri attribute
   */
  ...
  /**
   * Returns the catalog attribute node of the given catalog entry or null if there is no catalog
   * attribute
   *
   * @param element The catalog entry to get the catalog attribute of
   * @return the catalog attribute node of the given catalog entry or null if there is no catalog
   *     attribute
   */
  ...
  /**
   * Returns true if this element is a catalog entry that is required to have the 'uri' attribute
   * and false otherwise
   *
   * @param element The element to check
   * @return true if this element is an catalog entry that is required to have the 'uri' attribute
   *     and false otherwise
   */
  ...
  /**
   * Returns true if this element is a catalog entry that is required to have the 'catalog'
   * attribute and false otherwise
   *
   * @param element The element to check
   * @return true if this element is an catalog entry that is required to have the 'catalog'
   *     attribute and false otherwise
   */
  ...
  public static String getResolvedLocation(DOMDocument document, CatalogEntry catalogEntry) {
    ...
    try {
      return XMLEntityManager.expandSystemId(
          location, FilesUtils.removeFileScheme(document.getDocumentURI()), false);
