...
/**
 * Code action to find the expected element name defined in the given xsd and replace it
 *
 * <p>Given this XML where 'root' is defined as the root element in the XSD
 *
 * <p><test></test> -> Error: Cannot find declaration of 'test'
 *
 * <p>To fix the error, the code action will suggest replacing 'test' with 'root' in both the
  ...
  public void doCodeAction(
    ...
    try {
      ...
      for (String expectedElementText : expectedElements) {
        CodeAction addReplaceRootElement =
            CodeActionFactory.replaceAt(
