 ...
 *
 * <p>Given this XML where the expected child elements are not present as defined in the XSD:
 *
 * <p><servlet></servlet> Error: Child elements are missing from element: - servlet
 *
 * <p>The following elements are expected: - description - display-name - icon - servlet-name
 *
...
public class cvc_complex_type_2_4_bCodeAction implements ICodeActionParticipant {
  ...
  public void doCodeAction(
    ...
    try {
      ...
      String insertStrRequired =
          generator.generateMissingElements(
              request.getComponent(ContentModelManager.class), element, true);

      CodeAction insertAllExpectedElement =
          CodeActionFactory.replace(
              "Insert all expected elements",
              targetRange,
              insertStrAll,
