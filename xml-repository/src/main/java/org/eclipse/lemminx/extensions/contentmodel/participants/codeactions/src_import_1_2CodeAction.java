...
public class src_import_1_2CodeAction implements ICodeActionParticipant {
  ...
  private CodeAction createNamespaceCodeAction(
      Diagnostic diagnostic, Range range, DOMDocument document, String prefix)
    ...
    return CodeActionFactory.insert(
        message,
  ...
  private CodeAction createTargetNamespaceCodeAction(
      Diagnostic diagnostic, DOMDocument document, String prefix) throws BadLocationException {
    ...
    return CodeActionFactory.insert(
        message,
        document.positionAt(root.getStartTagCloseOffset()),
        " targetNamespace=\"\"",
        document.getTextDocument(),
        diagnostic);
  }
