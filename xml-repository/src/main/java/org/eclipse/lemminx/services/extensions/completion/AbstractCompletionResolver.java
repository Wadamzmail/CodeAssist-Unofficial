...
public abstract class AbstractCompletionResolver implements ICompletionItemResolveParticipant {
  ...
  /**
   * Resolve the given completion item <code>toResolve</code> by using the given DOM node.
   *
   * @param node the DOM retrieved by the offset coming from the completion item data.
