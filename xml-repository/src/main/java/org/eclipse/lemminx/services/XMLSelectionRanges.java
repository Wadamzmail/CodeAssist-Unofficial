...
class XMLSelectionRanges {
  ...
  /**
   * Returns the selection ranges given the cursor positions and the model of the XML document
   *
   * @param xmlDocument the model of the XML document
   * @param positions the list of cursor positions
   * @param cancelChecker the cancel checker
   * @return the selection ranges given the cursor positions and the model of the XML document
   */
  ...
  private SelectionRange getSelectionRangeFromCursorPosition(
  ...
  private SelectionRange handleNodeSelectionRange(
      SelectionRange selectionRange, DOMNode node, int offset) {
  ...
  private SelectionRange handleAttributeSelectionRange(
      SelectionRange selectionRange, DOMAttr attr, int offset) {
  ...
  private SelectionRange handleElementSelectionRange(
      SelectionRange selectionRange, DOMElement element, int offset) {
    ...
    if (contentStart != DOMNode.NULL_VALUE
        && contentEnd != DOMNode.NULL_VALUE
        && offset >= contentStart
        && offset <= contentEnd) {
      Range range =
          XMLPositionUtility.createRange(contentStart, contentEnd, element.getOwnerDocument());
  ...
  private SelectionRange handleDoctypeSelectionRange(
      SelectionRange selectionRange, DOMDocumentType doctype, int offset) {
  ...
  private SelectionRange handleGenericNodeSelectionRange(
      SelectionRange selectionRange, DOMNode node, int offset) {
