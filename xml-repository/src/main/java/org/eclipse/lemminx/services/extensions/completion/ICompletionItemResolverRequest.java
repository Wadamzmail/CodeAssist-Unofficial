...
/**
 * Represents a request from the client to resolve a given completion item, with information needed
 * to resolve the request attached.
 */
public interface ICompletionItemResolverRequest extends ISharedSettingsRequest, IComponentProvider {
   ...
   * @return the value of a field from the supplementary data attached to the request as a string
   */
  String getDataProperty(String fieldName);

  /**
   * Returns the value of a field from the supplementary data attached to the request as an integer,
   * or null if the field is not an integer.
   *
   * @param fieldName the name of the field to retrieve the data from
   * @return the value of a field from the supplementary data attached to the request as an integer,
   *     or null if the field is not an integer
   */
  Integer getDataPropertyAsInt(String fieldName);

  /**
   * Returns the value of a field from the supplementary data attached to the request as an boolean,
   * or null if the field is not an boolean.
   *
   * @param fieldName the name of the field to retrieve the data from
   * @return the value of a field from the supplementary data attached to the request as an boolean,
   *     or null if the field is not an boolean
   */
   ...
   *
   * @return the completion offset coming from the completion item data and null otherwise.
   */
