...
/**
 * Resolves the completion item of an element completion with an additional text edits to update end
 * tag.
 */
public class ElementEndTagCompletionResolver extends AbstractCompletionResolver {
  ...
  private static void resolveEndTagNameTextEdit(
      DOMNode node, ICompletionItemResolverRequest request, CompletionItem toResolve) {
