  ...
  public void formatComment(
    ...
    for (int i = commentNode.getStartContent(); i < commentNode.getEndContent(); i++) {
      ...
      if (Character.isWhitespace(c)) {
        ...
        if (startRange != -1
            && endRange != -1
            && (startRange > spaceStart || endRange < spaceEnd)) {
          return;
        }
        int contentStart = i;
        ...
        if (isMaxLineWidthSupported()) {
          ...
          if (commentNode.getStartContent() != contentStart
              && isJoinCommentLines()
          ...
          if (availableLineWidth < 0 && spaceStart != -1) {
            ...
            replaceLeftSpacesWithIndentation(indentLevel, spaceStart, contentStart, true, edits);
