...
public interface ISharedSettingsRequest {
  ...
  /**
   * Returns <code>true</code> if the client can support the given Markup kind for documentation and
   * <code>false</code> otherwise.
   *
   * @param kind the markup kind
   * @return <code>true</code> if the client can support the given Markup kind for documentation and
   *     <code>false</code> otherwise.
   */
