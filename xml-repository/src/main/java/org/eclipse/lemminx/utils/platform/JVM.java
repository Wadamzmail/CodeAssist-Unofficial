...
public class JVM {
  ...
  public JVM() {
    ...
    this.runtime =
        Platform.getSystemProperty("java.runtime.name"); // ex : OpenJDK Runtime Environment
   ...
   *
   * <p>Do not include this information in telemetry, as it likely includes the user's name
   *
