/**
 * Copyright (c) 2018 TypeFox GmbH (http://www.typefox.io) and others. All rights reserved. This
...
public class XMLServerSocketLauncher {
  ...
  /**
   * Launches {@link XMLLanguageServer} using asynchronous server-socket channel and makes it
   * accessible through the JSON RPC protocol defined by the LSP.
   *
   * @param args standard launch arguments. may contain <code>--port</code> argument to change the
   *     default port 5008
   */
