...
public class DOMUtils {
  ...
  private static final WeakHashMap<DOMNode, Map<String, Object>> sUserDataHolder =
      new WeakHashMap<>();
  ...
  public static String getNamespace(@NotNull DOMAttr attr) {
    ...
    ResourceNamespace.Resolver namespaceResolver = getNamespaceResolver(attr.getOwnerDocument());
  ...
  public static <T extends DOMNode> List<T> findChildrenOfType(
      DOMNode element, Class<T> domElementClass) {
