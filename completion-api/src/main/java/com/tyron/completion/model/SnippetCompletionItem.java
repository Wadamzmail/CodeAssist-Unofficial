...
public class SnippetCompletionItem extends CompletionItem {
    ...
    public SnippetCompletionItem(String label, SnippetDescription snippet) {
        this(label, null, snippet);
    }

    public SnippetCompletionItem(String label, String desc, SnippetDescription snippet) {
        this(label, desc, DrawableKind.Snippet, snippet);
    }

    public SnippetCompletionItem(String label, String desc, DrawableKind kind, SnippetDescription snippet) {
        super(label, desc,"", kind);
