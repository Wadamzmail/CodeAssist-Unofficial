 ...
 * [newText].
 */
data class TextEdit(var range: com.tyron.completion.model.location.Range, var newText: String) {
  companion object {
    @JvmField val NONE: TextEdit = TextEdit(com.tyron.completion.model.location.Range.NONE, "")
  }
}
