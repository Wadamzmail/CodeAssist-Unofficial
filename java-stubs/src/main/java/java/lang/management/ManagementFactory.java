...
public class ManagementFactory {
  ...
  public static synchronized MBeanServer getPlatformMBeanServer() {
    return new MBeanServer() {
      @Override
      public ObjectInstance createMBean(String var1, ObjectName var2)
      ...
      @Override
      public ObjectInstance createMBean(String var1, ObjectName var2, ObjectName var3)
          throws ReflectionException,
              InstanceAlreadyExistsException,
              MBeanRegistrationException,
              MBeanException,
      ...
      @Override
      public ObjectInstance createMBean(String var1, ObjectName var2, Object[] var3, String[] var4)
          throws ReflectionException,
              InstanceAlreadyExistsException,
              MBeanRegistrationException,
              MBeanException,
      ...
      public ObjectInstance createMBean(
          String var1, ObjectName var2, ObjectName var3, Object[] var4, String[] var5)
          throws ReflectionException,
              InstanceAlreadyExistsException,
              MBeanRegistrationException,
              MBeanException,
      ...
      @Override
      public ObjectInstance registerMBean(Object var1, ObjectName var2)
      ...
      @Override
      public Object getAttribute(ObjectName var1, String var2)
      ...
      @Override
      public AttributeList getAttributes(ObjectName var1, String[] var2)
          throws InstanceNotFoundException, ReflectionException {
        return null;
      }

      @Override
      public void setAttribute(ObjectName var1, Attribute var2)
      ...
      @Override
      public AttributeList setAttributes(ObjectName var1, AttributeList var2)
          throws InstanceNotFoundException, ReflectionException {
        return null;
      }

      @Override
      public Object invoke(ObjectName var1, String var2, Object[] var3, String[] var4)
      ...
      public void addNotificationListener(
          ObjectName var1, NotificationListener var2, NotificationFilter var3, Object var4)
          throws InstanceNotFoundException {}

      @Override
      public void addNotificationListener(
          ObjectName var1, ObjectName var2, NotificationFilter var3, Object var4)
          throws InstanceNotFoundException {}

      @Override
      public void removeNotificationListener(ObjectName var1, ObjectName var2)
      ...
      @Override
      public void removeNotificationListener(ObjectName var1, NotificationListener var2)
          throws InstanceNotFoundException, ListenerNotFoundException {}
      ...
      @Override
      public MBeanInfo getMBeanInfo(ObjectName var1)
      ...
      @Override
      public Object instantiate(String var1, ObjectName var2)
          throws ReflectionException, MBeanException, InstanceNotFoundException {
        return null;
      }

      @Override
      public Object instantiate(String var1, Object[] var2, String[] var3)
          throws ReflectionException, MBeanException {
        return null;
      }

      @Override
      public Object instantiate(String var1, ObjectName var2, Object[] var3, String[] var4)
          throws ReflectionException, MBeanException, InstanceNotFoundException {
        return null;
      }
  ...
  //    public static <T> T newPlatformMXBeanProxy(MBeanServerConnection connection, String
  // mxbeanName, Class<T> mxbeanInterface) throws IOException {
  ...
  //                    throw new IllegalArgumentException(mxbeanName + " is not an instance of " +
  // mxbeanInterface);
  //                } else {
  ...
  //    }
  //
  //    private static boolean isInstanceOf(MBeanServerConnection connection, ObjectName objName,
  // String intfName) throws InstanceNotFoundException, IOException {
  ...
  //    }
  //
  //    public static <T extends PlatformManagedObject> T getPlatformMXBean(Class<T>
  // mxbeanInterface) {
  //        PlatformComponent<?> pc =
  // ManagementFactory.PlatformMBeanFinder.findSingleton(mxbeanInterface);
  ...
  //    }
  //
  //    public static <T extends PlatformManagedObject> List<T> getPlatformMXBeans(Class<T>
  // mxbeanInterface) {
  //        PlatformComponent<?> pc =
  // ManagementFactory.PlatformMBeanFinder.findFirst(mxbeanInterface);
  //        if (pc == null) {
  //            throw new IllegalArgumentException(mxbeanInterface.getName() + " is not a platform
  ...
  //    }
  //
  //    public static <T extends PlatformManagedObject> T getPlatformMXBean(MBeanServerConnection
  // connection, Class<T> mxbeanInterface) throws IOException {
  //        PlatformComponent<?> pc =
  // ManagementFactory.PlatformMBeanFinder.findSingleton(mxbeanInterface);
  //        return (T) newPlatformMXBeanProxy(connection, pc.getObjectNamePattern(),
  // mxbeanInterface);
  //    }
  //
  //    public static <T extends PlatformManagedObject> List<T>
  // getPlatformMXBeans(MBeanServerConnection connection, Class<T> mxbeanInterface) throws
  // IOException {
  //        PlatformComponent<?> pc =
  // ManagementFactory.PlatformMBeanFinder.findFirst(mxbeanInterface);
  //        if (pc == null) {
  ...
  //
  //            PlatformComponent p;
  //            for(Iterator var4 = platformComponents().iterator(); var4.hasNext(); names =
  // Stream.concat(names, getProxyNames(p, connection, mxbeanInterface))) {
  ...
  //    }
  //
  //    private static Stream<String> getProxyNames(PlatformComponent<?> pc, MBeanServerConnection
  // conn, Class<?> intf) throws IOException {
  //        if (pc.mbeanInterfaceNames().contains(intf.getName())) {
  //            return pc.isSingleton() ? Stream.of(pc.getObjectNamePattern()) :
  // conn.queryNames(Util.newObjectName(pc.getObjectNamePattern()),
  // (QueryExp)null).stream().map(ObjectName::getCanonicalName);
  //        } else {
  //            return Stream.empty();
  //        }
  //    }
  ...
  // platformComponents().stream().flatMap((pc) -> {
  ...
  //                    dmbean = new StandardEmitterMBean(pmo, (Class)null, true,
  ...
  //            return
  // ((Map)provider.getPlatformComponentList().stream().collect(Collectors.toMap(PlatformComponent::getObjectNamePattern, Function.identity(), (p1, p2) -> {
  //                throw new InternalError(p1.getObjectNamePattern() + " has been used as key for "
  // + p1 + ", it cannot be reused for " + p2);
  //            }))).values().stream();
  //        }
  //
  ...
  //            }).reduce((p1, p2) -> {
  //                if (p2 != null) {
  //                    throw new IllegalArgumentException(mbeanIntf.getName() + " can have more
  // than one instance");
  //                } else {
  //                    return p1;
  //                }
  //            });
  //            PlatformComponent<?> singleton = op.isPresent() ? (PlatformComponent)op.get() :
  // null;
  //            if (singleton == null) {
  //                throw new IllegalArgumentException(mbeanIntf.getName() + " is not a platform
  // management interface");
  //            } else if (!singleton.isSingleton()) {
  //                throw new IllegalArgumentException(mbeanIntf.getName() + " can have more than
  // one instance");
  //            } else {
  //                return singleton;
  //            }
  ...
  //                    (PlatformMBeanProvider) p)).collect(Collectors.toMap(o -> o,
