...
public interface PrioritizedContentListener extends ContentListener {
  /**
   * Comparator that sorts {@link ContentListener} objects by their {@link
   * PrioritizedContentListener#getPriority() priorities} (if any).
   *
   * <p>The rules are:
   *
   * <pre>
   ...
   * </pre>
   */
  Comparator<? super ContentListener> COMPARATOR =
