...
public abstract class FileEditorManager {
  ...
  /**
   * Convenience method to make the user select an editor in a list of file editors, typically shown
   * when there are more than one applicable editors to a file
   *
   * <p>this should be called on the main thread
   *
   ...
   */
  @NonNull
  public abstract FileEditor[] openFile(
      @NonNull Context context, @NonNull File file, boolean focus);
  ...
  public abstract void openChooser(
