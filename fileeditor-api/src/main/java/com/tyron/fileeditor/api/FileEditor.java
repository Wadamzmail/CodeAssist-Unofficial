...
public interface FileEditor {
  ...
  /**
   * @return The name of this editor to be distinguished from other editors. Note that this is not
   *     the name displayed from UI
   */
  @NonNull
  String getName();
  ...
  /**
   * @return whether this editor is valid or not. An editor may become invalid if the file it
   *     represents have been deleted.
   */
  boolean isValid();
