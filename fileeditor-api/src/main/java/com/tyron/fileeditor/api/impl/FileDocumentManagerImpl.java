...
public class FileDocumentManagerImpl extends FileDocumentManagerBase {
  ...
  private final PrioritizedContentListener physicalContentTracker =
      new PrioritizedContentListener() {
        @Override
  ...
  protected Content createContent(@NotNull CharSequence text, @NotNull FileObject file) {
    ...
    if (!iterator.hasNext()) {
      throw new IllegalStateException(
          "No content providers registered, there should be at least one.");
    }
