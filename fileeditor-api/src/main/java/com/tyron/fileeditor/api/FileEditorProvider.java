...
public interface FileEditorProvider {
   ...
   * @return whether the provider can create a valid editor instance for the specified file.
   */
  boolean accept(@NonNull File file);

  /**
   * Creates the editor for the specified file. This method is only called if the provider has
   * accepted this file in {@link #accept(File)}
   *
